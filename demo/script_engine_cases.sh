...
echo "CASE 1: pass with GET_PULL_RATE LT VERIFY, current quote is 5/12"
...
echo "CASE 2: fail with GET_PULL_RATE LT VERIFY, current quote is 5/12"
...
echo "CASE 3: pass with GET_PUSH_RATE EQ, current quote is 5/12"
...
echo "CASE 4: fail with GETHEIGHT GT, current block is smaller than 999999"
