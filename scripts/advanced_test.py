# scripts/advanced_script_test.py
...
WALLET = "test_user_advanced.json"
...
def main():
    ...
    # buy energy test with advanced script
    print("\n--- Buy Order Test: Advanced Script ---")
    advanced_script = "GET_PULL_RATE 600 LT VERIFY 1"
    
    print(f"Using Script: {advanced_script}\n")
    buy_res = run_cli(
        [
            "buy",
            "--energy-wh",
